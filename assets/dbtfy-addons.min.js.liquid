(function() {
  ...
  /* start-dbtfy-back-to-top */ function themeBackToTop(){ {%- if settings.dbtfy_back_to_top -%} document.body.classList.remove("dbtfy-back_to_top-destroy"); {%- endif -%} } function themeBackToTopDestroy() { {%- if settings.dbtfy_back_to_top -%} function destroyBackInStock(){const t=document.querySelectorAll(".dbtfy-back_to_top");t.length&&t.forEach((t=>{t.remove()}))}document.body.classList.add("dbtfy-back_to_top-destroy"),destroyBackInStock(); {%- endif -%} } /* end-dbtfy-back-to-top */
  ...
  /* start-dbtfy-cart-notification */ function themeCartNotification(){ {%- if settings.dbtfy_cart_notification -%} document.body.classList.remove("dbtfy-cart_notification-destroy"); {%- endif -%} } function themeCartNotificationDestroy() { {%- if settings.dbtfy_cart_notification -%} document.body.classList.add("dbtfy-cart_notification-destroy"); {%- endif -%} } /* end-dbtfy-cart-notification */
  ...
  /* start-dbtfy-remove-debutify-branding */ function themeRemoveDebutifyBranding(){ {%- if settings.dbtfy_remove_debutify_branding -%} document.body.classList.remove("dbtfy-remove_debutify_branding-destroy"); {%- endif -%} } function themeRemoveDebutifyBrandingDestroy() { {%- if settings.dbtfy_remove_debutify_branding -%} document.body.classList.add("dbtfy-remove_debutify_branding-destroy"); {%- endif -%} } /* end-dbtfy-remove-debutify-branding */
  ...
  /* start-dbtfy-show-second-image-on-hover */ function themeShowSecondImageOnHover(){ {%- if settings.dbtfy_show_second_image_on_hover -%} document.body.classList.remove("dbtfy-show_second_image_on_hover-destroy"); {%- endif -%} } function themeShowSecondImageOnHoverDestroy() { {%- if settings.dbtfy_show_second_image_on_hover -%} document.body.classList.add("dbtfy-show_second_image_on_hover-destroy"); {%- endif -%} } /* end-dbtfy-show-second-image-on-hover */
  ...
  /* start-dbtfy-skip-cart */ function themeSkipCart() { {%- if settings.dbtfy_skip_cart -%} document.body.classList.remove("dbtfy-skip_cart-destroy"); {%- endif -%} } function themeSkipCartDestroy() { {%- if settings.dbtfy_skip_cart -%} document.body.classList.add("dbtfy-skip_cart-destroy"); {%- endif -%} } /* end-dbtfy-skip-cart */
  ...
  /* start-dbtfy-sticky-header */ function themeStickyHeader(){ {%- if settings.dbtfy_sticky_header -%} document.body.classList.remove("dbtfy-sticky_header-destroy"); {%- endif -%} } function themeStickyHeaderDestroy() { {%- if settings.dbtfy_sticky_header -%} function destroyStickyHeader(){document.body.classList.remove("sticky-header")}document.body.classList.add("dbtfy-sticky_header-destroy"),destroyStickyHeader(); {%- endif -%} } /* end-dbtfy-sticky-header */
